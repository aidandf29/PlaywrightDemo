...
test("Fill Press and PressSeq Practice", async ({ page }) => {
  ...
  await page
    ...
    .fill("Learn for brighter tomorrow");
  await page
    .locator("#et_pb_contact_message_0")
    .pressSequentially("222", { delay: 2000 });
  await page
    .locator("#et_pb_contact_message_0")
    .press("Backspace", { delay: 2000 });
  await page.locator("#et_pb_contact_message_0").press("Backspace");
  ...
  //   await page
  //     .locator("#APjFqb")
  //     .pressSequentially("Playwright", { delay: 1000 });
